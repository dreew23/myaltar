...
import { BookOpen, Heart, Calendar, Target, Users, Shield, Sparkles, ChevronRight, Play } from "lucide-react"
          ...
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="font-playfair text-3xl md:text-4xl lg:text-5xl font-bold text-[#3C1E38]">
                Sacred Features That Transform Lives
              </h2>
              <Sparkles className="w-6 h-6 text-[#A7C2D7] ml-3" />
            </div>
            <p className="font-inter text-lg md:text-xl text-[#3C1E38]/70 max-w-3xl mx-auto">
              Every feature is thoughtfully designed to deepen your relationship with God while organizing your earthly
              responsibilities
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Your spiritual journey remains completely private and secure",
                stat: "100% Private",
              },
              {
                icon: BookOpen,
                title: "Scripture Powered",
                description: "Every feature is grounded in biblical wisdom and truth",
                stat: "1,000+ Verses",
              },
              {
                icon: Target,
                title: "Purpose Driven",
                description: "Align your daily actions with your divine calling and purpose",
                stat: "95% Success Rate",
              },
            ].map((highlight, index) => (
              <div key={index} className="text-center bg-white rounded-xl p-6 shadow-lg border border-[#A7C2D7]/20">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#A7C2D7] to-[#F9D57E] flex items-center justify-center mx-auto mb-4">
                  <highlight.icon className="w-8 h-8 text-white" />
                </div>
                <div className="font-playfair text-2xl font-bold text-[#A7C2D7] mb-2">{highlight.stat}</div>
                <h3 className="font-playfair text-lg font-semibold text-[#3C1E38] mb-2">{highlight.title}</h3>
                <p className="font-inter text-[#3C1E38]/70">{highlight.description}</p>
              </div>
            ))}
          </div>
        </div>

...
export default function ProductCTA() {
  const handleStartTrial = () => {
    trackButtonClick("Start Free Trial", "product_cta")
    trackEvent("conversion_intent", "product", "free_trial_bottom")
    // Handle trial signup
  }

  const handleScheduleDemo = () => {
    trackButtonClick("Schedule Demo", "product_cta")
    trackEvent("demo_request", "product", "personal_demo")
    // Handle demo scheduling
  }

  return (
    <section id="product-cta" className="py-16 md:py-24 bg-gradient-to-br from-[#A7C2D7]/10 to-[#F9D57E]/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-[#A7C2D7]/20 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="font-inter text-lg md:text-xl text-[#3C1E38]/70 mb-8 max-w-2xl mx-auto">
                Join thousands of women who have transformed their daily planning into sacred practice. Start your
                14-day free trial and experience the divine difference.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-[#3C1E38]/60">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded-full bg-[#A7C2D7]"></div>
                  <span>Cancel anytime</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded-full bg-[#F9D57E]"></div>
          ...
          <div className="mt-12 text-center">
            <p className="font-inter text-[#3C1E38]/60 mb-4">
              Questions about how ALTAR can transform your spiritual practice?
            </p>
            <a
              href="mailto:hello@altar.app"
